...
from employee_service.api.api_v1.api import api_router
from employee_service.api.errors.http_error import http_error_handler
from employee_service.api.errors.validation_error import http422_error_handler
from employee_service.api.openapi import custom_openapi
from employee_service.api.openapi import use_route_names_as_operation_ids
from employee_service.core.config import get_app_settings
from employee_service.db.init_db import init_db
from employee_service.db.session import SessionLocal, engine

current_file = Path(__file__)
current_file_dir = current_file.parent
project_root = current_file_dir.parent
project_root_absolute = project_root.resolve()
project_templates_path = project_root_absolute / "employee_service/templates"
