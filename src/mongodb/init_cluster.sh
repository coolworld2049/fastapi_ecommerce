...
docker-compose exec configsvr01 bash -c "mongosh < /scripts/init-configserver.js"
docker-compose exec shard01-a bash -c "mongosh < /scripts/init-shard01.js"
docker-compose exec shard02-a bash -c "mongosh < /scripts/init-shard02.js"
docker-compose exec router01 bash -c "mongosh < /scripts/init-router.js"
