...
from order_service.api.dependencies import auth, database
...
async def test_celery(
    ...
    Test Celery worker.
    """
    celery_app.send_task("order_service.worker.test_celery", args=[msg.msg])
...
async def test_celery_is_cart_expries(
    ...
    celery_app.send_task(
        "order_service.tasks.is_cart_expries", args=(db, cart_id)
    )
    return {"msg": "Word received"}
